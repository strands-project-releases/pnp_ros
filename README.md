...
## pnp_ros (indigo) - 0.0.9-0

The packages in the `pnp_ros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo pnp_ros` on `Wed, 20 Jul 2016 11:32:13 -0000`
...
## pnp_ros (indigo) - 0.0.8-0

The packages in the `pnp_ros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo pnp_ros` on `Wed, 20 Jul 2016 11:12:31 -0000`
...
## pnp_ros (indigo) - 0.0.7-0

The packages in the `pnp_ros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo pnp_ros` on `Tue, 26 Apr 2016 14:22:53 -0000`
...
## pnp_ros (indigo) - 0.0.6-0

The packages in the `pnp_ros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo pnp_ros` on `Tue, 26 Apr 2016 13:22:54 -0000`
...
## pnp_ros (indigo) - 0.0.5-0

The packages in the `pnp_ros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo pnp_ros` on `Tue, 26 Apr 2016 10:27:30 -0000`
